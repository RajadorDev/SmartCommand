...
trait SubCommandHolderTrait
{
     ...
     * @return self
     */
    public function registerSubCommands(SubCommand ...$subCommands) : self 
    {
     ...
     * @return bool 
     */
    abstract protected function executeSubCommand(CommandSender $sender, SubCommand $subCommand, string $commandLabel, string $subCommandLabel, array $args) : bool;
